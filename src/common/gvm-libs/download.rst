.. code-block::
  ...
  curl -L https://github.com/greenbone/gvm-libs/releases/download/v$GVM_VERSION/gvm-libs-$GVM_VERSION.tar.gz.asc -o $SOURCE_DIR/gvm-libs-$GVM_VERSION.tar.gz.asc
