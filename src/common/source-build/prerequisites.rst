...
.. code-block::
  :caption: Debian Creating a gvm system user and group

  sudo useradd -r -M -U -G sudo -s /usr/sbin/nologin gvm

.. code-block::
  :caption: Fedora Creating a gvm system user and group
...
.. code-block::
  :caption: Debian installing common build dependencies
...
.. code-block::
  :caption: Fedora installing common build dependencies
  ...
  sudo dnf remove -y net-snmp net-snmp-devel
  sudo dnf install \
    systemd \
    gcc \
    openssl-devel \
