...
For updating your **source build** from a previous version of this guide, see [](./deployment/source-build/workflows.md#updating-to-newer-releases).

For updating your installation of the **Greenbone Community Containers**, see
[](./deployment/container/workflows.md#updating-the-greenbone-community-containers).
